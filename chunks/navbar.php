<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Devil's Kitchen</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/Devil" class="hvr-grow">Home</a></li>
		        <li><a href="/Devil/about-devilskitchen.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="foods.php" class="hvr-grow">Foods</a></li>
				<li><a href="food-categories_1.php" class="hvr-grow">Table Reservation</a></li>
				
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can order directly by calling to this number 021-1111111 also. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/Devil">Home</a></li>
	        <li><a href="/Devil/about-devilskitchen.php">About Us</a></li>
	        <li><a href="food-categories.php">Categories</a></li>
	        <li><a href="foods.php">Foods</a></li>
			<li><a href="foods-categories_1.php" class="hvr-grow">Table Reservation</a></li>
